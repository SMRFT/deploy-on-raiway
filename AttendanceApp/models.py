...
class Employee(models.Model):
    ...
    # proof = models.FileField(GridFSStorage())
    # certificates = models.FileField(GridFSStorage())
    file = models.FileField(GridFSStorage())
    ...
    # imgSrc = models.FileField(GridFSStorage())
